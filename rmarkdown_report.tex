...
\begin{verbatim}
[93721:1217/010113.178151:ERROR:gles2_cmd_decoder.cc(17766)] [.RenderCompositor-0x7f97d301ce00]GL ERROR :GL_INVALID_OPERATION : glBindTexImage2DCHROMIUM: no image found with the given ID
\end{verbatim}
...
\includegraphics{rmarkdown_report_files/figure-latex/unnamed-chunk-15-1.pdf}
...
\NormalTok{sum lngdp}
\NormalTok{global mean_lngdp =}\StringTok{ }\KeywordTok{r}\NormalTok{(mean)}
\NormalTok{version}
...
\NormalTok{    putexcel C2=}\StringTok{"1960"}\NormalTok{ D2=}\StringTok{"1965"}\NormalTok{ E2=}\StringTok{"1970"}\NormalTok{ F2=}\StringTok{"1975"}\NormalTok{ G2=}\StringTok{"1980"}\NormalTok{ H2=}\StringTok{"1985"}\NormalTok{ I2=}\StringTok{"1990"}\NormalTok{ J2=}\StringTok{"1995"}\NormalTok{ K2=}\StringTok{"2000"}
\NormalTok{    putexcel B3 =}\StringTok{ }\KeywordTok{matrix}\NormalTok{(mean_educ), rownames }\KeywordTok{nformat}\NormalTok{(number_d2) right}
