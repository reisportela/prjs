...
\KeywordTok{stargazer}\NormalTok{(nls, }
          ...
          \DataTypeTok{label=}\StringTok{"tab:tab1"}\NormalTok{, }
...
\includegraphics{rmarkdown_report_files/figure-latex/unnamed-chunk-4-1.pdf} \includegraphics{rmarkdown_report_files/figure-latex/unnamed-chunk-4-2.pdf} \includegraphics{rmarkdown_report_files/figure-latex/unnamed-chunk-4-3.pdf} \includegraphics{rmarkdown_report_files/figure-latex/unnamed-chunk-4-4.pdf}
...
\begin{verbatim}
Error in py_call_impl(callable, dots$args, dots$keywords): ImportError: No module named requests
...
\begin{verbatim}
Error in py_call_impl(callable, dots$args, dots$keywords): NameError: name 'requests' is not defined
...
\begin{verbatim}
Error in py_call_impl(callable, dots$args, dots$keywords): NameError: name 'valor' is not defined
...
\begin{verbatim}
Error in py_call_impl(callable, dots$args, dots$keywords): TypeError: 'encoding' is an invalid keyword argument for this function
...
\NormalTok{quiet cd }\StringTok{"/Users/miguelportela/Dropbox/1.miguel/bdp/4.code_ados/rmarkdown/logs"}
\NormalTok{quiet import delimited }\StringTok{"/Users/miguelportela/Dropbox/1.miguel/bdp/4.code_ados/rmarkdown/checks/data/PE.csv"}\NormalTok{, encoding(ISO-8859-2) }\KeywordTok{clear} 
...
\includegraphics{rmarkdown_report_files/figure-latex/unnamed-chunk-12-1.pdf}
...
\CommentTok{##eda_report(nlswork,output_dir = "/Users/miguelportela/Dropbox/1.miguel/bdp/4.code_ados/rmarkdown/checks/reports/",output_file = "eda_report.pdf")}
...
\CommentTok{##os.chdir('/Users/miguelportela/Dropbox/1.miguel/bdp/1.BDs/zonafranca/python_tests/')}
...
\NormalTok{quiet cd }\StringTok{"/Users/miguelportela/Dropbox/1.miguel/bdp/4.code_ados/rmarkdown/logs"}
\NormalTok{quiet import delimited }\StringTok{"/Users/miguelportela/Dropbox/1.miguel/bdp/4.code_ados/rmarkdown/checks/data/PE.csv"}\NormalTok{, }\KeywordTok{encoding}\NormalTok{(ISO}\DecValTok{-8859-2}\NormalTok{) clear }
...
\KeywordTok{setwd}\NormalTok{(}\StringTok{"/Users/miguelportela/Dropbox/1.miguel/bdp/4.code_ados/rmarkdown/logs"}\NormalTok{)}
\KeywordTok{rm}\NormalTok{(}\DataTypeTok{list =} \KeywordTok{ls}\NormalTok{())}
\KeywordTok{library}\NormalTok{(haven)}
\NormalTok{nlswork <-}\StringTok{ }\KeywordTok{read_dta}\NormalTok{(}\StringTok{"../data/nlswork.dta"}\NormalTok{)}
\NormalTok{nlswork <-}\StringTok{ }\KeywordTok{read.csv}\NormalTok{(}\StringTok{"../data/nlswork.csv"}\NormalTok{)}
...
\KeywordTok{stargazer}\NormalTok{(nlswork, }\DataTypeTok{summary.stat =} \KeywordTok{c}\NormalTok{(}\StringTok{"n"}\NormalTok{, }\StringTok{"p75"}\NormalTok{, }\StringTok{"sd"}\NormalTok{), }\DataTypeTok{summary.logical =} \OtherTok{FALSE}\NormalTok{, }
...
\NormalTok{quiet cd }\StringTok{"/Users/miguelportela/Dropbox/1.miguel/bdp/4.code_ados/rmarkdown/checks/logs"}
...
\NormalTok{graph export }\StringTok{"/Users/miguelportela/Dropbox/1.miguel/bdp/4.code_ados/rmarkdown/checks/logs/density.pdf"}\NormalTok{, replace}
...
\NormalTok{cd }\StringTok{"/Users/miguelportela/Dropbox/1.miguel/bdp/4.code_ados/rmarkdown/checks/logs"}
