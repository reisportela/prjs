...
\includegraphics{rmarkdown_report_files/figure-latex/unnamed-chunk-4-4.pdf} \includegraphics{rmarkdown_report_files/figure-latex/unnamed-chunk-4-5.pdf}

\begin{verbatim}
Error in ggplot(nlswork, aes(x = hours, y = year)): could not find function "ggplot"
\end{verbatim}
...
-- Variable type:numeric -----------------------------------------------------------------
 ...
 nlswork$ln_wage       0    28534 28534 1.67 0.48  0 1.36 1.64 1.96 5.26
     hist
 ▁▃▇▃▁▁▁▁
\end{verbatim}
...
#  [4] skimr_1.0.7         naniar_0.4.2        visdat_0.5.3        
#  [7] dlookr_0.3.12       mice_3.6.0          lattice_0.20-38     
# [10] dplyr_0.8.3         haven_2.1.1         ExPanDaR_0.4.0      
# [13] Statamarkdown_0.3.9 stargazer_5.2.2     reticulate_1.13     
#  
...
\KeywordTok{library}\NormalTok{(}\StringTok{"skimr"}\NormalTok{)}
  ...
  \KeywordTok{summary}\NormalTok{(nlswork}\OperatorTok{$}\NormalTok{ln_wage)}
\NormalTok{  skimr}\OperatorTok{::}\KeywordTok{skim}\NormalTok{(nlswork}\OperatorTok{$}\NormalTok{ln_wage)}
  \KeywordTok{str}\NormalTok{(nlswork}\OperatorTok{$}\NormalTok{ln_wage)}

  
\NormalTok{dplyr}\OperatorTok{::}\KeywordTok{n_distinct}\NormalTok{(nlswork)}
\NormalTok{dplyr}\OperatorTok{::}\KeywordTok{n_distinct}\NormalTok{(ln_wage)}
\KeywordTok{n_miss}\NormalTok{(union)}
\KeywordTok{n_complete}\NormalTok{(union)}
